...
class HTCondorJobQ(Source.Source):
    ...
    def acquire(self):
        ...
        job_manifests = [
            {"JobId": "1.0", "RequestCpus": 2,
                "RequestMemory": 4, "RequestTime": 12},
            {"JobId": "2.0", "RequestCpus": 2,
                "RequestMemory": 4, "RequestTime": 12},
            {"JobId": "3.0", "RequestCpus": 2,
                "RequestMemory": 4, "RequestTime": 12},
            {"JobId": "3.1", "RequestCpus": 2,
                "RequestMemory": 4, "RequestTime": 12},
            {"JobId": "3.2", "RequestCpus": 2,
                "RequestMemory": 4, "RequestTime": 12},
