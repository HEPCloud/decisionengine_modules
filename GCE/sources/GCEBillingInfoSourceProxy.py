...
class GCEBillingInfoSourceProxy(SourceProxy.SourceProxy):


    def __init__(self, config):
        super(GCEBillingInfoSourceProxy, self).__init__(config)
    ...
    def acquire(self):
        ...
        data = super(GCEBillingInfoSourceProxy, self).acquire()
...
def module_config_template():
    ...
    template = {
        'gce_billing_info_source_proxy': {
            'module': 'decisionengine_modules.GCE.sources.GCEBillingInfoSourceProxy',
            'name': 'GCEBillingInfoSourceProxy',
            'parameters': {
