...
class GceBurnRateSourceProxy(SourceProxy.SourceProxy):


    def __init__(self, config):
        super(GceBurnRateSourceProxy, self).__init__(config)
    ...
    def acquire(self):
        ...
        data = super(GceBurnRateSourceProxy, self).acquire()
...
def module_config_template():
    ...
    template = {
        'billing_info_source_proxy': {
            'module': 'decisionengine_modules.GCE.sources.GceBurnRateSourceProxy',
            'name': 'GceBurnRateSourceProxy',
            'parameters': {
