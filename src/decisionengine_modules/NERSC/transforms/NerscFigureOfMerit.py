...
@Transform.produces(Nersc_Price_Performance=pd.DataFrame,
...
class NerscFigureOfMerit(Transform.Transform):
    ...
    def transform(self, data_block):
        ...
        """
        self.get_logger().debug("in NerscFigureOfMerit::transform()")
        ...
        return {'Nersc_Price_Performance': performance.filter(["EntryName", "PricePerformance"]),
