...
valid_datablock = pandas.DataFrame(
    {"EntryName": ["CMSHTPC_T3_US_NERSC_Cori", "CMSHTPC_T3_US_NERSC_Cori2"], "FigureOfMerit": [1.0, 0.3]}
)

# expected output
valid_output_dict = {"CMSHTPC_T3_US_NERSC_Cori.fig_of_merit": 1.0, "CMSHTPC_T3_US_NERSC_Cori2.fig_of_merit": 0.3}


class TestNerscFigureOfMeritPublisher:
    def test_consumes(self):
        fom_pub = NerscFigureOfMerit_publisher.NerscFigureOfMeritPublisher(config_fom_pub)
